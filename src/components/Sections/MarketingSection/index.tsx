...
const MarketingSection = () => {
  ...
  /* Styles */
  const heroBackgroundStyle = `bg-slate-100 h-full bg-no-repeat bg-cover py-8 lg:py-24 flex items-center z-10`;
  ...
  return (
    <section className="h-full flex flex-col relative " id="home">
      <div className={heroBackgroundStyle}>
        <Container>
          {/* Hero Content */}
          <div className={`bg-[#212121] rounded-3xl py-8 lg:py-0 px-4 md:px-16 w-full ${heroContainerStyle}`}>
          <div className="lg:max-w-2xl">
            ...
            >
              <Heading className="!text-white font-extrabold">
                Seu site moderno em diferentes telas
              </Heading>
            </motion.div>
          ...
          >
          <div className="flex justify-center relative absolute lg:left-16">
              <Image
                src={grid}
                alt={"Grid"}
                className=""
